...
for name,end in [('boundary-port',3.56),('extended-port',3.86)]:
...
(R/'header-port-control.json').write_text(json.dumps({'scope':'Two isolated routing-adapter fixtures only. No managed source is loaded or changed; the copper/service-band geometry is identical except for a 0.30 mm inward fixed-lead extension.','results':results},indent=2))
