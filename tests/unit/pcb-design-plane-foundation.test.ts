...
describe("direct-toolbox V2 plane contract foundation", () => {
  it("preserves the captured omitted-interface V2 compiler, artifacts, guide, bundle bytes and canonical DRU", () => {
    ...
    expect(contentIdentity(PCB_PLANE_DESIGN_INTENT_MODEL_GUIDE)).toEqual({ algorithm: "sha256", digest: "4e49118e1728bd31ba03d84716351336a1e6deb1c57f0e8b5826a93dad8edb80", size: 10701 });
