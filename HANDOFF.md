...
The [September 19 local placement study](designs/rp2350-pico/placement-study-20260919/README.md) now has a USB-only source proposal meeting termination distance and copper length/skew limits. It is **not adopted**: combined regulator/flash routing and capacitor returns remain incomplete. All managed native sources are unchanged. Review the recorded failed samples before further placement work.
