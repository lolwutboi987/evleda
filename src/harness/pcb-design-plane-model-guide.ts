...
export const PCB_PLANE_DESIGN_INTENT_MODEL_GUIDE_VERSION =
  "evleda.pcb-plane-design-intent-model-guide.v2" as const;
...
export const PCB_PLANE_DESIGN_INTENT_MODEL_GUIDE = [
  ...
  "scope.board requires shape, widthMm, heightMm, layerCount, copperLayers. Unknown dimensions are null. Two-layer copperLayers contains F.Cu and B.Cu exactly once; four-layer copperLayers contains F.Cu, In1.Cu, In2.Cu and B.Cu exactly once. Four-layer boards require explicit four_layer construction. The rectangle runs from (0,0) to (widthMm,heightMm); all placement and plane coordinates share that frame. Compilation does not establish native authoring support: four-layer project creation is currently unavailable until the native path is qualified.",
