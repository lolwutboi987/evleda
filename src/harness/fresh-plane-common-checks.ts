...
export const FRESH_PLANE_COMMON_CHECKS_LIMITS = Object.freeze({ maximumPcbBytes: 2 * 1024 * 1024,
  maximumSegments: FRESH_PCB_RESOURCE_LIMITS.maximumSegments,
  maximumVias: FRESH_PCB_RESOURCE_LIMITS.maximumVias, maximumPhysicalPads: 512, maximumCoordinateNm: 2_000_000_000 });
