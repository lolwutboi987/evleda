...
The global `evleda_workspace` entry now uses **frozen host48, DOC17 and the v4
approved library profile**, plus an exact copy of the current PCB skill.
[Native and client qualification](../proofs/native-reference-gap-20260920/README.md)
