...
The global `evleda_workspace` entry now uses **frozen host63 on the D: USB drive, DOC17 and the v4
approved library profile**, plus an exact copy of the current PCB skill.
[Native trace-topology qualification and fresh client discovery](../proofs/trace-topology-20260921/README.md)
