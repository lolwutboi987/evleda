...
The global `evleda_workspace` entry now uses **frozen host50, DOC17 and the v4
approved library profile**, plus an exact copy of the current PCB skill.
[Native and client qualification](../proofs/terminal-launch-policy-20260920/README.md)
